...
public class LogIn_with_QR extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogIn_with_QR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new LogIn_with_QR().setVisible(true);
        });
    }
