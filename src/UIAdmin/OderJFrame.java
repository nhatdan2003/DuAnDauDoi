...
public class OderJFrame extends javax.swing.JFrame {
	...
	private void selectTable(String TenBan) {
	...
	private void fillStatusTable() {
		...
		order = odDAO.selectAll();
		for (Order tb : order) {
			String check = tb.getIdTable();
			switch (check) {
				case "B1":
					if (tb.getStatusTable()) {
						btnBan1.setBackground(Color.decode("#66ff66"));
						
					}
					break;
				case "B2":
					if (tb.getStatusTable()) {
						btnBan2.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B3":
					if (tb.getStatusTable()) {
						btnBan3.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B4":
					if (tb.getStatusTable()) {
						btnBan4.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B5":
					if (tb.getStatusTable()) {
						btnBan5.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B6":
					if (tb.getStatusTable()) {
						btnBan6.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B7":
					if (tb.getStatusTable()) {
						btnBan7.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B8":
					if (tb.getStatusTable()) {
						btnBan8.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B9":
					if (tb.getStatusTable()) {
						btnBan9.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B10":
					if (tb.getStatusTable()) {
						btnBan10.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B11":
					if (tb.getStatusTable()) {
						btnBan11.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B12":
					if (tb.getStatusTable()) {
						btnBan12.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B13":
					if (tb.getStatusTable()) {
						btnBan13.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B14":
					if (tb.getStatusTable()) {
						btnBan14.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B15":
					if (tb.getStatusTable()) {
						btnBan15.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B16":
					if (tb.getStatusTable()) {
						btnBan16.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B17":
					if (tb.getStatusTable()) {
						btnBan17.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B18":
					if (tb.getStatusTable()) {
						btnBan18.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B19":
					if (tb.getStatusTable()) {
						btnBan19.setBackground(Color.decode("#66ff66"));
					}
					break;
				case "B20":
					if (tb.getStatusTable()) {
						btnBan20.setBackground(Color.decode("#66ff66"));
					}
					break;
